...
public class BlankFragment6 extends Fragment {
    ...
    related1 = inflater.inflate(R.layout.fragment_blank6, container, false);
    recyclerView = related1.findViewById(R.id.re);


    Myadapter8 myadapter8 = new Myadapter8(this,imageListt,d1,d2);
    recyclerView.setAdapter(myadapter8);
    LinearLayoutManager layoutManager8 = new LinearLayoutManager(getActivity());
    recyclerView.setLayoutManager(layoutManager8);
