...
public class BlankFragment4 extends Fragment {
    ...
    related1 = inflater.inflate(R.layout.fragment_blank4, container, false);
    recyclerView = related1.findViewById(R.id.re);


    Myadapter6 myadapter6 = new Myadapter6(this,imageListt,d1,d2);
    recyclerView.setAdapter(myadapter6);
    LinearLayoutManager layoutManager6 = new LinearLayoutManager(getActivity());
    recyclerView.setLayoutManager(layoutManager6);
