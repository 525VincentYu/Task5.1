...
public class Myadapter4 extends RecyclerView.Adapter<Myadapter4.MyViewHolder> {
    int image[];
    String data1[], data2[];
    BlankFragment2 context;
    public Myadapter4(BlankFragment2 ct, int[] imag, String []s1, String[]s2){
       this.context = ct;
        image = imag;
        data1 = s1;
        data2 = s2;
    ...
    public Myadapter4.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Myadapter4.MyViewHolder myViewHoder = new Myadapter4.MyViewHolder(view);
        return myViewHoder;
    }
