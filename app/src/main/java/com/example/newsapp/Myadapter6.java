...
public class Myadapter6 extends RecyclerView.Adapter<Myadapter6.MyViewHolder> {
    int image[];
    String data1[], data2[];
    BlankFragment4 context;
    public Myadapter6(BlankFragment4 ct, int[] imag, String []s1, String[]s2){
       this.context = ct;
        image = imag;
        data1 = s1;
        data2 = s2;
    ...
    public Myadapter6.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Myadapter6.MyViewHolder myViewHoder = new Myadapter6.MyViewHolder(view);
        return myViewHoder;
    }
